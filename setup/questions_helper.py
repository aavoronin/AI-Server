...
class QuestionsHelper:
    ...
    def get_vacancy_json_questions():
        ...
        TECHNICAL_SKILLS = [
            "Python", "SQL", "Java", "JavaScript", "C++", "Bash", "C#", "TypeScript", "R", "Go", "PHP", "Kotlin",
            "Swift", "Ruby", "Rust", "Scala", "Dart", "MATLAB", "Perl", "Objective-C", "Julia", "Lua", "PowerShell",
            "Solidity", "Elixir", "F#", "C", "GDScript", "Ada", "Haskell",
            "PostgreSQL", "MySQL", "T-SQL", "PL/SQL", "Snowflake SQL", "BigQuery SQL", "PL/pgSQL", "Redshift SQL",
            "SQLite", "Spark SQL", "MariaDB", "HiveQL", "Teradata SQL", "DB2 SQL", "Trino SQL",
            "Power BI", "Tableau", "Looker", "Qlik", "Amazon QuickSight", "MicroStrategy", "SAP Analytics Cloud",
            "IBM Cognos", "TIBCO Spotfire", "Domo", "Sisense", "ThoughtSpot", "Oracle Analytics", "Metabase",
            "Apache Superset",
            "Apache Airflow", "dbt", "Informatica", "Apache Spark", "AWS Glue", "Azure Data Factory", "Talend",
            "IBM DataStage", "SSIS", "Fivetran", "Matillion", "Apache NiFi", "Dagster", "Airbyte", "Alteryx",
            "Apache Beam", "Google Cloud Dataflow", "Prefect", "Pentaho", "Dell Boomi", "SAP BODS",
            "Oracle Data Integrator", "Apache Flink", "Luigi", "SnapLogic", "Stitch", "Mage", "HVR", "Qlik Replicate",
            "Kafka Connect",
            "Star Schema", "Snowflake Schema", "3NF", "Anchor Modeling", "Data Vault", "Columnstore", "Query Plan",
            "SCD", "Fact Table", "Dimension Table", "Surrogate Key", "Conformed Dimension", "Data Mart",
            "Data Lakehouse", "OLAP", "OLTP", "ELT", "ETL", "CDC", "Table Partitioning", "Sharding",
            "Materialized View", "Degenerate Dimension", "Junk Dimension", "Bridge Table", "Role-Playing Dimension",
            "Data Lineage", "Data Governance", "MDM", "Kimball Methodology", "Inmon Methodology",
            "Medallion Architecture", "Data Mesh", "Denormalization", "Upsert", "Bitmap Index", "Data Quality",
            "Aggregation Table", "Natural Key", "Data Fabric",
            "Tables", "Views", "Indexes", "Triggers", "Stored Procedures", "Primary Key", "Foreign Key",
            "Normalization", "Denormalization", "ACID", "Transactions", "Isolation Levels", "Locking", "Deadlocks",
            "MVCC", "Execution Plan", "Query Optimization", "Partitioning", "Sharding", "Connection Pooling",
            "Referential Integrity", "Constraints", "Unique Constraint", "Check Constraint", "Composite Key",
            "ER Diagram", "Cardinality", "CTEs", "Window Functions", "Materialized Views", "B-Tree Index",
            "Full-Text Search", "Row-Level Security", "Optimistic Locking", "Pessimistic Locking", "Temp Tables",
            "Sequences", "UDFs",
            "Wireframing", "Prototyping", "User Research", "Usability Testing", "Information Architecture",
            "Interaction Design", "Visual Design", "Typography", "Color Theory", "Responsive Design", "Accessibility",
            "User Personas", "User Journeys", "Empathy Mapping", "Card Sorting", "Heuristic Evaluation",
            "Cognitive Load", "Affordance", "Signifiers", "Feedback Loops", "Micro-interactions", "Design Systems",
            "Figma", "Sketch", "Adobe XD", "InVision", "A/B Testing", "CRO", "Mobile-First Design", "Dark Mode UI",
            "Machine Learning", "Deep Learning", "Neural Networks", "NLP", "Computer Vision", "Reinforcement Learning",
            "Supervised Learning", "Unsupervised Learning", "Semi-Supervised Learning", "Transfer Learning",
            "Generative AI", "LLMs", "Prompt Engineering", "RAG", "Fine-Tuning", "Regression", "Classification",
            "Clustering", "Dimensionality Reduction", "Random Forest", "SVM", "Gradient Boosting", "K-Means", "DBSCAN",
            "CNN", "RNN", "Transformers", "Attention Mechanism", "GANs", "Autoencoders", "Tokenization", "Embeddings",
            "Word2Vec", "BERT", "GPT", "Model Evaluation", "Cross-Validation", "Overfitting", "Underfitting",
            "Hyperparameter Tuning", "Feature Engineering", "Feature Selection", "Data Preprocessing", "EDA",
            "Time Series Analysis", "Anomaly Detection", "Recommender Systems", "Bias and Fairness", "Explainable AI",
            "MLOps", "Data Versioning", "Model Deployment", "Edge AI", "Federated Learning", "Quantum Machine Learning",
            "Synthetic Data", "Data Augmentation", "Loss Functions", "Optimization Algorithms", "Gradient Descent",
            "AWS", "Azure", "GCP", "IBM Cloud", "Oracle Cloud", "Alibaba Cloud", "Salesforce", "DigitalOcean", "VMware",
            "Rackspace",
            "Terraform", "Ansible", "Docker", "Kubernetes", "Jenkins", "GitHub Actions", "GitLab CI", "ArgoCD",
            "Prometheus", "Grafana",
            "Kafka", "RabbitMQ", "Redis", "Apache Pulsar", "NATS", "Redis Streams",
            "PyTest", "Jest", "Mocha", "Cypress", "Selenium", "JUnit", "Playwright", "Postman",
            "Jira", "Confluence", "Notion", "Slack", "Microsoft Teams", "Asana",
            "Linux", "Windows", "macOS"
        ]
        ...
        for idx, (vacancy_text, real_expected) in enumerate(real_data):
            ...
            for k in keys:
                if k in KEY_DEFINITIONS:
                    definitions_str += f"\n{k}: {KEY_DEFINITIONS[k]}"
                elif k in TECHNICAL_SKILLS:
                    definitions_str += f"\n{k}: Required proficiency level. Use only these exact string values: expert, required, nice-to-have, or no."
                else:
                    definitions_str += f"\n{k}: Extract the value for {k} from the text."
